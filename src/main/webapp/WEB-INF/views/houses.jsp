...
<header class="topbar">
    ...
    <nav class="nav">
        <a href="/deals">실거래가</a>
        <a class="active" href="/houses">주거 단지</a>
...
<main class="page">
    <section class="page-head">
        <h1>주거 단지 검색</h1>
        <p>초기 DB의 법정동, 아파트 기본 정보, 거래 이력을 연결하고 연립다세대 실거래는 실거래가 화면에서 함께 확인합니다.</p>
    </section>

    <section class="panel search-panel">
        <div class="form-grid">
            <label class="wide">통합 검색 <input id="houseKeyword" placeholder="지역, 동, 법정동 코드, 단지명, 도로명"></label>
            <label>법정동 코드 <input id="dongCode" placeholder="선택 입력"></label>
        </div>
        <div class="actions">
            <button id="searchHouses">통합 검색</button>
            <button id="searchDongCodes" class="secondary">지역 코드만 보기</button>
        </div>
    </section>
